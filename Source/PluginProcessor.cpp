...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("LowCut Freq", "LowCut Freq", freqRange, 20.f));
    layout.add(std::make_unique<juce::AudioParameterFloat>("HighCut Freq", "HighCut Freq", freqRange, 20000.f));
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Freq", "Peak Freq", freqRange, 750.f));
